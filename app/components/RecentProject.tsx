...
const RecentProjects = () => {
  return (
    <div id="projects" className="py-20 relative">
      ...
      <div className="flex flex-wrap items-center justify-center p-4 gap-x-16 lg:gap-y-10 mt-10">
        {projects.map((item) => (
          <div
          ...
          >
            ...
            >
              ...
              <h1 className="font-bold lg:text-1xl md:text-xl text-base line-clamp-1 text-white-100">
                {item.title}
              </h1>
